						...
						<table id="datatablesSimple">
							...
							<tbody>
								...
								while ($row=$rs->fetch_array(MYSQLI_ASSOC)) {
									if ($row['Id_maestro']==36) { $nombre_maestro = "Sin docente asignado"; $color = 'style = "background-color: rgb(217, 136, 128);" ';  } else { $nombre_maestro = $row['nombre_maestro'].' '.$row['apellidos']; $color = 'style = "background-color: rgb(125, 206, 160);" '; }
									...
									$edit = '<div class="btn-group">
		                                <button type="button" class="btn btn-outline-success btn2" data-bs-toggle="dropdown" aria-expanded="false" title="Editar Materia" >
		                                    <i class="bi bi-pencil-square" data-bs-toggle="modal" data-bs-target="#edit_'.$row['Id'].'"></i>
		                                </button>
		                            </div>';
		                            
									$delete = '<div class="btn-group">
		                                <button type="button" class="btn btn-outline-danger btn2" data-bs-toggle="dropdown" aria-expanded="false" title="Eliminar Materia" >

	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="myModalLabel">ELIMINAR MATERIA</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="container-fluid">
					<form method="POST" action="DeleteRegistro.php" enctype="multipart/form-data">
					<input type="hidden" name="id" id="id" class='form-control' required="required" value="<?php echo $row['Id']; ?>">
